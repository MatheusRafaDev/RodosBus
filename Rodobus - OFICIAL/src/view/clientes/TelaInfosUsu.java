 ...
 */
package telainfousuarioscom.mycompany.mavenproject1;

/**
 *
 * @author alesandro.rsjunior
 */
public class TelaInfosUsu extends javax.swing.JFrame {

    /**
     * Creates new form TelaInfosUsu
     */
    public TelaInfosUsu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("RODOBUS");

        jLabel3.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Olá, Gabriel");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInfosUsu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInfosUsu().setVisible(true);
            }
        });
    }
