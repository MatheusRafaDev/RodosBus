...
public class ConstrutorHTML {
    ...
    public static String criarConteudoHTMLBoasVindas(Passageiro passageiro) {
        ...
        String emailBody = "<!DOCTYPE html>\n"
                ...
                + "\n"
                + "    <p>Olá " + passageiro.getNomeCompleto() + " ,</p>\n"
                + "\n"
    ...
    public static String criarConteudoHTMLRecuperacaoSenha(String codigoRecuperacao) {
        ...
        String emailBody = "<!DOCTYPE html>\n"
                ...
                + "        <div class=\"content\">\n"
                + "            <p>Prezado Usuário,</p>\n"
                + "            <p>Recebemos uma solicitação para recuperação de senha. Utilize o código abaixo para redefinir sua senha:</p>\n"
                + "            <p>Código de Recuperação: <strong>" + codigoRecuperacao + "</strong></p>\n"
                + "            <p>Este código é válido por um curto período. Não compartilhe com ninguém.</p>\n"
                + "        </div>\n"
                + "    </div>\n"
                + "</body>\n"
                + "</html>";
    ...
    public static String criarConteudoHTMLConfirmacaoSenha(String novaSenha) {
